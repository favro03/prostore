...
const ProductForm = ({type, product, productId}: {
    ...
    // @ts-expect-error - Type mismatch between create/update schemas
    resolver:
      type === 'Update'
          ...
          />
            ...
            render={({
              ...
              <FormItem className='w-full'>
                ...
                <Button
                  type='button'
                  className='bg-gray-500 hover:bg-gray-600 text-white px-3 py-1 text-sm mt-1 w-fit'
                  onClick={() => {
                    form.setValue(
                      'slug',
                  ...
                  <CardContent className="space-y-2 mt-2 min-h-48">
                    <div className="flex-start space-x-2">
                      {images.map((image: string) => (
                        <Image key={image} src={image} alt="product image" className="w-20 h-20 object-voer object-center rounded-sm" width={100} height={100}/>
                      ))}
                      <FormControl>
